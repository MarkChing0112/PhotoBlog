...
<head>
    ...
    <nav class="navbar navbar-light bg-dark justify-content-between" style="background-color: rgb(46, 52, 63)">
        <a  href="<c:url value="/Photos/home" />" class="navbar-brand mb-0 h1" style="color: rgb(255, 255, 255)"  >PhotoBlog</a>
...
<form:form method="POST" enctype="multipart/form-data" modelAttribute="bookForm">
    ...
    <b>photos</b><br/>
    <input type="file" name="photos" multiple="multiple" accept="image/png, image/jpeg, image/gif"/><br/><br/>
